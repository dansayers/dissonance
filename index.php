        ...
        <div id="about" class="tab-pane">
          <div class="row-fluid row-item">
            <div class="span12">
              ...
              <p>To start, there is a single note set to 440Hz - at the 'zero' position of the graph above. The graph shows an approximate scale of human-perceived dissonance when adding similar but differently pitched notes. The x-axis measures pitch in cents - hundredths of a semitone - and the vertical grey lines mark off semitones. The dips (local minima) of the graph are indicated by dots. Clicking on these will add notes that should sound consonant, or at least "minimally dissonant" compared to nearby pitches. You can also click on the curve at any other point (e.g. dissonance maxima) to see what other tunings and collections of notes sound like. You can add, delete or edit notes using the notes tab. Slider values can by fine-tuned by clicking in the track to the left and right of the slider 'handle'.</p>
